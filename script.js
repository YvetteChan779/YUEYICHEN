...
(function () {
    ...
    const i18n = {
        en: {
            ...
            'experience.roboscience.b1': '<strong>PLAN-A:</strong> engineered a multimodal social-robot interaction stack with Qwen2.5-VL/OpenCV perception, Text-to-Action CVAE, image-conditioned Diffusion Policy, and 10D WebSocket + Dynamixel execution over 194 reaction episodes.',
            'experience.roboscience.b2': '<strong>PLAN-B:</strong> built a Jetson AGX Orin voice-to-grasp pipeline spanning VAD/ASR/NLU/VLM/SAM3/depth/grasp FSM, lifting documented far-field VAD hit rate from 0% to 92% and SAM3 mask success from 9% to at least 90%.',
            'experience.roboscience.b3': '<strong>Coin Stand to Place:</strong> developed an xArm6 + LEAP Hand closed-loop manipulation workflow with D435 / fingertip cameras, checkpoint hot-switching, grasp verification, rule-based half-arc transfer, and automated episode reset.',
        ...
        zh: {
            ...
            'experience.roboscience.b1': '<strong>PLAN-A：</strong>工程化实现多模态社交机器人交互栈，覆盖 Qwen2.5-VL/OpenCV 感知、Text-to-Action CVAE、图像条件 Diffusion Policy，以及 194 个反应 episode 上的 10D WebSocket + Dynamixel 执行链路。',
            'experience.roboscience.b2': '<strong>PLAN-B：</strong>在 Jetson AGX Orin 上构建 voice-to-grasp 管线，串联 VAD/ASR/NLU/VLM/SAM3/depth/grasp FSM，将文档记录的远场 VAD 命中率从 0% 提升到 92%，SAM3 mask 成功率从 9% 提升到至少 90%。',
            'experience.roboscience.b3': '<strong>Coin Stand to Place：</strong>开发 xArm6 + LEAP Hand 闭环操作流程，集成 D435 / 指尖相机、checkpoint 热切换、抓取验证、规则化半弧转移动作与 episode 自动复位。',
