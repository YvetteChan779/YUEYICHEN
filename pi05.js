(function () {
    ...
    const i18n = {
        en: {
            ...
            's2.cap3': 'Per-suite success (%) for the 55k Full-LoRA checkpoint; dashed lines mark the official π0.5 (92.2) and OpenVLA-7B (76.0) mean baselines.',
        ...
        zh: {
            ...
            's2.cap3': '55k Full-LoRA checkpoint 的逐 suite 成功率（%）；虚线为官方 π0.5（92.2）与 OpenVLA-7B（76.0）的平均基线。',
